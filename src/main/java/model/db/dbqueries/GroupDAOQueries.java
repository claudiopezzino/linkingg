...
public class GroupDAOQueries {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    private static final String SELECT_GROUPS_NAME_ASKED_TO_JOIN =
            "SELECT name FROM crowd JOIN requests ON nickname = groups_nickname WHERE users_nickname = ?";
    //////////////////////////////////////////////////////////////////////////////////////////////////////

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static final String SELECT_GROUPS_NICKNAME_ASKED_TO_JOIN = "SELECT groups_nickname FROM requests WHERE users_nickname = ?";
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static final String SELECT_GROUPS_BY_NAME =
            "SELECT * FROM crowd WHERE name LIKE ? AND name NOT IN (" + SELECT_GROUPS_NAME_OWNED_BY_USER + ") " +
            "AND name NOT IN (" + SELECT_GROUPS_NAME_NOT_OWNED_BY_USER + ") " +
            "AND name NOT IN (" + SELECT_GROUPS_NAME_ASKED_TO_JOIN + ")";
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////

    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static final String SELECT_GROUPS_BY_NICKNAME =
            "SELECT * FROM crowd WHERE nickname LIKE ? AND nickname NOT IN (" + SELECT_GROUPS_NICKNAME_OWNED_BY_USER + ") " +
            "AND nickname NOT IN (" + SELECT_GROUPS_NICKNAME_NOT_OWNED_BY_USER + ") " +
            "AND nickname NOT IN (" + SELECT_GROUPS_NICKNAME_ASKED_TO_JOIN + ")";
    
    private static final String SELECT_GROUPS_BY_PROVINCE =
            "SELECT * FROM crowd JOIN users ON owner = users.nickname WHERE province LIKE ? AND crowd.nickname NOT IN (" + SELECT_GROUPS_NICKNAME_OWNED_BY_USER +") AND " +
                    "crowd.nickname NOT IN (" + SELECT_GROUPS_NICKNAME_NOT_OWNED_BY_USER + ") AND " +
                    "crowd.nickname NOT IN (" + SELECT_GROUPS_NICKNAME_ASKED_TO_JOIN + ")";
    
    private static final String INSERT_NEW_MEMBER = "INSERT INTO users_into_groups(users_nickname, groups_nickname) VALUES(?,?)";
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void insertNewMember(PersistencyDB db, Connection connection, String userNick, String groupNick) throws DBException{
        PreparedStatement preparedStatement = null;
        try{
            preparedStatement = connection.prepareStatement(INSERT_NEW_MEMBER,
                    ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    private static void initSelectGroupsByFilterStatement(PreparedStatement preparedStatement, String userNick, String filterName) throws SQLException{
        ...
        preparedStatement.setString(4, userNick);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
