...
public final class Css {
    ...
    public static final String SIGN_BUTTONS = "button-sign";
    public static final String TOOL_ELEMENTS = "tool-element";
    public static final String BUTTONS_PREVIEW = "button-preview";
    public static final String SIGNS_TITLE = "access-title";
