...
public final class DefaultCommands {
    ...
    public static final String LINK_REQUESTS= "link requests";

    public static final String LINK_INVITATION = "link invitation";
    public static final String LINK_REQUEST = "link request";
